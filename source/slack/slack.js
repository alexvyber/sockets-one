...
let namespaces = require("./data/namespaces.cjs")
...
namespaces.forEach(namespace => {
  io.of(namespace.endpoint).on("connect", nsSocket => {
    ...
    // --
    nsSocket.on("joinRoom", ({ roomToJoin, roomToLeave }, someCallback) => {
      {
    ...
    nsSocket.on("newMessageToServer", msg => {
      ...
      if (!(msg.room in nsSocket.rooms)) throw new Error("Room doesn't found")
